...
import com.example.springjwt.payloads.request.LoginRequest;
import com.example.springjwt.payloads.request.SignupRequest;
import com.example.springjwt.payloads.response.JwtResponse;
import com.example.springjwt.payloads.response.MessageResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "manager":
                        ...
                        break;
                    case "collab":
                        Role collabRole = roleRepository.findByName(ERole.ROLE_COLLABORATER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
